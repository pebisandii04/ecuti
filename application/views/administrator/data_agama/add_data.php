            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo base_url() . ''; ?>">Data Agama</a></li>
                  <li class="breadcrumb-item active">Add Data Agama</li>
                </ol>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    <div class="tab-content">
                      <div class="active tab-pane">
                        <form action="<?php echo base_url() . 'data_agama/add_data'; ?>" method="post" enctype="multipart/form-data">
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              <label class="small mb-1">Nama Agama</label>
                              <input class="form-control" type="text" name="nama_agama" value="<?php echo set_value('nama_agama') ?>" />
