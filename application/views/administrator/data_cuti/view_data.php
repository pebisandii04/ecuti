                                ...
                                foreach ($data_cuti as $row) { ?>
                                    <tr>
                                        ...
                                        <?php if ($row->sts_apv_2 == 1) { ?>
                                            <a href="<?php echo base_url() . 'C_cuti/edit/' . $row->id_cuti; ?>" class="btn btn-sm btn-secondary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="<?php echo base_url() . 'C_cuti/delete/' . $row->id_cuti; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah data ini akan di hapus ?')">
