    ...
    <!-- Content Header (Page header) -->
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1> <i class="fas fa-file-signature fa-fw"></i> Rekap Data Cuti Umum</h1>
                </div>
                <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?php echo base_url().''; ?>">Dashboard</a></li>
                <li class="breadcrumb-item active">Rekap Data Cuti Umum</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Rekap Data Cuti Umum</h3>
                    </div>
                    <!--/.card-header -->
                    <div class="card-body">
                                ...
                                foreach ($data_cuti as $row) { ?>
                                    <tr>
                                        ...
                                        <?php if ($row->sts_apv_2 == 0) { ?>
                                            <a href="<?php echo base_url() . 'Laporan/Cetak_lampiran_cu_adm/' .$row->nip.'/' . $row->pejabat_id.'/' . $row->id_user; ?>" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Cetak Lampiran" target="blank">
