          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url().''; ?>">Data Jabatan</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane">
                      <form action="<?php echo base_url().'data_jabatan/edit_data'; ?>" method="post" enctype="multipart/form-data">
                          <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="small mb-1">Nama Jabatan</label>
                                <input type="hidden" name="id_jabatan" value="<?php echo $data_jabatan['id_jabatan']; ?>">
                                <input class="form-control" type="text" name="nama_jabatan" value="<?php echo $data_jabatan['nama_jabatan']; ?>" />
