                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane">
                      <form action="<?php echo base_url() . 'data_jenis_pegawai/update_data'; ?>" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                          <div class="form-group col-md-12">
                            <label class="small mb-1">Nama Jenis Pegawai</label>
                            <input type="hidden" name="id_jenis_pegawai" value="<?php echo $data_jenis_pegawai['id_jenis_pegawai']; ?>">
                            <input class="form-control" type="text" name="nama_jenis_pegawai" value="<?php echo $data_jenis_pegawai['nama_jenis_pegawai']; ?>" />
