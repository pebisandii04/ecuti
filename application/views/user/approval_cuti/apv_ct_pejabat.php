                                ...
                                foreach ($list_data as $row) { ?>
                                    <tr>
                                        ...
                                        <td  class="text-center">
                                            <a href="<?php echo base_url() . 'Data_cuti_tahunan/approve_pejabat/' . $row->id_cuti_tahunan; ?>" class="btn btn-sm btn-secondary" onclick="return confirm('Are you sure you want to agree ?')">
                                                <i class="fas fa-check"></i>
                                            </a>
                                            <a href="<?php echo base_url() . 'Data_cuti_tahunan/tolak_ct_pejabat/' .$row->id_user.'/'. $row->id_cuti_tahunan; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to reject it ?')">
