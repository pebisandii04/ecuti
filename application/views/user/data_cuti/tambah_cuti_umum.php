    ...
    <!-- Content Header (Page header) -->
         <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> <i class="fas fa-file-signature fa-fw"></i> Form Pengajuan Cuti Umum</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-5">
                                            ...
                                            <textarea name="alamat" value="<?php echo set_value('alamat'); ?>" id="" cols="9" rows="5" class="form-control mb-2"></textarea>
