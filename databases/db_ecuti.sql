...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Apr 2021 pada 17.24
...
(1, '196501151992121001', 'PUJI HARIAN, S.H, M.Hum.', 'Blitar, Kabupaten (Kanigoro)', '1965-01-15', 1, 1, 1, 16, '082232051166', 1, 1, '24472.jpg', 'pujiharian@mahkamahagung.go.id', '$2y$10$nHZV3HcbURTC9dgP50862Ofw/hRxjIvpeZK.Dcer9oNCfDqBzhbH2', 3, 1),
...
--
ALTER TABLE `tbl_user_token`
  MODIFY `id_user_token` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tbl_cuti_tahunan`
  ADD CONSTRAINT `tbl_cuti_tahunan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`id_user`),
